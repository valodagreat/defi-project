...
contract Staking is ERC20, Ownable {
   ...
   function createStake(uint256 _stake) public {
       ...
       stakes[msg.sender].timeDueForStakeWithdrawal = block.timestamp + 7 seconds;
       approve(msg.sender,_stakeWithDecimals);
       transferFrom(msg.sender, address(this),_stakeWithDecimals);
   }
   ...
   function removeStake(uint256 _stake) public onlyStakeHolders{
       ...
       require(balanceOf(address(this))>= _stakeWithDecimals, "Insufficient" );
...
//    }
   ...
   function claimReward () public payable onlyStakeHolders{
       require( block.timestamp > (stakes[msg.sender].timeDueForStakeWithdrawal), "Cannot claim reward until after a week");
        ...
        //removeStake(stakes[msg.sender].amountStaked/ 1 *10**18);
